...
def create_prompt(query, res):
    ...
    prompt_start = ("Answer the question based on the context and sentiment of the question. Also, do not discuss any Personally Identifiable Information.\n\n" + "Context:\n")
    prompt_end = (f"\n\nQuestion: {query}\nAnswer:")
...
def create_system_prompt():
    system_prompt = f"""
    You are a cryptocurrency scams specialist at a scam listing service that educates customers about these scams.
    """
